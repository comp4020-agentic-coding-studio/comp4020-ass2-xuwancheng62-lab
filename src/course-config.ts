...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A twelve-week directing practicum built around one recurring short film. " +
    "You develop story, shot design, performance direction, editing rhythm and " +
    "sound, then practice each skill immediately against an AI cast and crew " +
    "fast enough to reshoot before the next class.",
  tags: ["directing", "filmmaking", "AI production"],
